...
apt-get install -y php8.1-curl php8.1-cli php8.1-intl php8.1-mysqlnd php8.1-gd php8.1-fpm php8.1-mbstring php8.1-xml unzip nginx mysql-server-5.7 php8.1-xdebug
