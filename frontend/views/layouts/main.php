...
$this->beginPage() ?>
    ...
    <head>
        ...
        <!--    <link href="--><?
        //= Yii::getAlias('@web/image/cart.png') ?><!--" rel="icon"/>-->
        <?php
        $this->head() ?>
    </head>
                        ...
                        <div class='col d-flex flex-row'>
                            ...
                            <div class='top_bar_content ml-auto'>
                                ...
                                <div class='top_bar_user'>
                                    <div class='user_icon'><img src=<?= Yii::getAlias('@web/images/user.svg') ?> alt=''>
                                    </div>
                                ...
                                <div class='menu_contact'>
                                    <div class='menu_contact_item'>
                                        <div class='menu_contact_icon'>
                                            <img src=<?= Yii::getAlias('@web/images/phone_white.png') ?> alt=''></div>
                                        +38 068 005 3570
                                    </div>
                                    <div class='menu_contact_item'>
