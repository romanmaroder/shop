    ...
    <header class='header'>
                ...
                <div class='row'>
                    <div class='col d-flex flex-row'>
                        <div class='top_bar_contact_item'>
                            <div class='top_bar_icon'><img src=<?= Yii::getAlias('@web/images/phone.png') ?> alt=''></div>
                            +38 068 005 3570</div>
                        <div class='top_bar_contact_item'>
                            <div class='top_bar_icon'><img src=<?= Yii::getAlias('@web/images/mail.png') ?> alt=''></div>
                        ...
                        <div class='top_bar_content ml-auto'>
                            ...
                            <div class='top_bar_user'>
                                <div class='user_icon'><img src=<?= Yii::getAlias('@web/images/user.svg') ?> alt=''></div>
                    ...
                    <div class='col-lg-4 col-9 order-lg-3 order-2 text-lg-left text-right'>
                        <div class='wishlist_cart d-flex flex-row align-items-center justify-content-end'>
                            <div class='wishlist d-flex flex-row align-items-center justify-content-end'>
                                <div class='wishlist_icon'><img src=<?= Yii::getAlias('@web/images/heart.png') ?> alt=''></div>
                        ...
                        <div class='page_menu_content'>
                            ...
                            <div class='menu_contact'>
                                <div class='menu_contact_item'>
                                    <div class='menu_contact_icon'><img src=<?= Yii::getAlias('@web/images/phone_white.png') ?> alt=''></div>
                                    +38 068 005 3570</div>
                                <div class='menu_contact_item'>
                                    <div class='menu_contact_icon'><img src=<?= Yii::getAlias('@web/images/mail_white.png') ?> alt=''></div>
                                    <a href='mailto:fastsales@gmail.com'>fastsales@gmail.com</a></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class='row'>
                    ...
                    <div class='col-lg-3 col-md-6 char_col'>
                        ...
                        <div class='char_item d-flex flex-row align-items-center justify-content-start'>
                            <div class='char_icon'><img src=<?= Yii::getAlias('@web/images/char_1.png') ?> alt=''></div>
                    ...
                    <div class='col-lg-3 col-md-6 char_col'>
                        ...
                        <div class='char_item d-flex flex-row align-items-center justify-content-start'>
                            <div class='char_icon'><img src=<?= Yii::getAlias('@web/images/char_2.png') ?> alt=''></div>
                            <div class='char_content'>
                                <div class='char_title'>Free Delivery</div>
                                <div class='char_subtitle'>from $50</div>
                            </div>
                    ...
                    <div class='col-lg-3 col-md-6 char_col'>
                        ...
                        <div class='char_item d-flex flex-row align-items-center justify-content-start'>
                            <div class='char_icon'><img src=<?= Yii::getAlias('@web/images/char_3.png') ?> alt=''></div>
                            <div class='char_content'>
                                <div class='char_title'>Free Delivery</div>
                                <div class='char_subtitle'>from $50</div>
                            </div>
                    ...
                    <div class='col-lg-3 col-md-6 char_col'>
                        ...
                        <div class='char_item d-flex flex-row align-items-center justify-content-start'>
                            <div class='char_icon'><img src=<?= Yii::getAlias('@web/images/char_4.png') ?> alt=''></div>
                            <div class='char_content'>
                                <div class='char_title'>Free Delivery</div>
                                <div class='char_subtitle'>from $50</div>
                            </div>
                                ...
                                <div class='owl-carousel owl-theme deals_slider'>
                                    ...
                                    <div class='owl-item deals_item'>
                                        <div class='deals_image'>
                                            <img alt='' src=<?= Yii::getAlias('@web/images/deals.png') ?>>
                                        </div>
                                    ...
                                    <div class='owl-item deals_item'>
                                        <div class='deals_image'><img
                                                    src=<?= Yii::getAlias('@web/images/deals.png') ?> alt=''></div>
                                        <div class='deals_content'>
                                            <div class='deals_info_line d-flex flex-row justify-content-start'>
                                                <div class='deals_item_category'><a href='#'>Headphones</a></div>
                                                <div class='deals_item_price_a ml-auto'>$300</div>
                                    ...
                                    <div class='featured_slider slider'>
                                        ...
                                        <div class='featured_slider_item'>
                                            ...
                                            <div class='product_item discount d-flex flex-column align-items-center justify-content-center text-center'>
                                                <div class='product_image d-flex flex-column align-items-center justify-content-center'>
                                                    <img src=<?= Yii::getAlias('@web/images/featured_1.png') ?> alt=''>
                                                </div>
                                        ...
                                        <div class='featured_slider_item'>
                                            ...
                                            <div class='product_item is_new d-flex flex-column align-items-center justify-content-center text-center'>
                                                <div class='product_image d-flex flex-column align-items-center justify-content-center'>
                                                    <img src=<?= Yii::getAlias('@web/images/featured_2.png') ?> alt=''>
                                                </div>
                                                <div class='product_content'>
                                        ...
                                        <div class='featured_slider_item'>
                                            ...
                                            <div class='product_item d-flex flex-column align-items-center justify-content-center text-center'>
                                                <div class='product_image d-flex flex-column align-items-center justify-content-center'>
                                                    <img src=<?= Yii::getAlias('@web/images/featured_3.png') ?> alt=''>
                                                </div>
                                                <div class='product_content'>
                                                    <div class='product_price'>$379</div>
                                                    <div class='product_name'>
                                        ...
                                        <div class='featured_slider_item'>
                                            ...
                                            <div class='product_item discount d-flex flex-column align-items-center justify-content-center text-center'>
                                                <div class='product_image d-flex flex-column align-items-center justify-content-center'>
                                                    <img src=<?= Yii::getAlias('@web/images/featured_4.png') ?> alt=''>
                                                </div>
                                                <div class='product_content'>
                                                    <div class='product_price discount'>$225<span>$300</span></div>
                                                    <div class='product_name'>
                                        ...
                                        <div class='featured_slider_item'>
                                            ...
                                            <div class='product_item d-flex flex-column align-items-center justify-content-center text-center'>
                                                <div class='product_image d-flex flex-column align-items-center justify-content-center'>
                                                    <img src=<?= Yii::getAlias('@web/images/featured_5.png') ?> alt=''>
                                                </div>
                                                <div class='product_content'>
                                        ...
                                        <div class='featured_slider_item'>
                                            ...
                                            <div class='product_item d-flex flex-column align-items-center justify-content-center text-center'>
                                                <div class='product_image d-flex flex-column align-items-center justify-content-center'>
                                                    <img src=<?= Yii::getAlias('@web/images/featured_6.png') ?> alt=''>
                                                </div>
                                                <div class='product_content'>
                                                    <div class='product_price'>$379</div>
                                                    <div class='product_name'>
                                        ...
                                        <div class='featured_slider_item'>
                                            ...
                                            <div class='product_item is_new d-flex flex-column align-items-center justify-content-center text-center'>
                                                <div class='product_image d-flex flex-column align-items-center justify-content-center'>
                                                    <img src=<?= Yii::getAlias('@web/images/featured_7.png') ?> alt=''>
                                                </div>
                                                <div class='product_content'>
                                                    <div class='product_price'>$379</div>
                                                    <div class='product_name'>
                                        ...
                                        <div class='featured_slider_item'>
                                            ...
                                            <div class='product_item d-flex flex-column align-items-center justify-content-center text-center'>
                                                <div class='product_image d-flex flex-column align-items-center justify-content-center'>
                                                    <img src=<?= Yii::getAlias('@web/images/featured_8.png') ?> alt=''>
                                                </div>
                                                <div class='product_content'>
                                                    <div class='product_price'>$225</div>
                                                    <div class='product_name'>
                            ...
                            <div class='owl-carousel owl-theme popular_categories_slider'>
                                ...
                                <div class='owl-item'>
                                    <div class='popular_category d-flex flex-column align-items-center justify-content-center'>
                                        <div class='popular_category_image'><img src=<?= Yii::getAlias(
                                                '@web/images/popular_1.png'
                                            ) ?> alt=''></div>
        ...
        <div class='banner_2'>
            <div class='banner_2_background'
                 style='background-image:url(<?= Yii::getAlias('@web/images/banner_2_background.jpg') ?>)'></div>
                                ...
                                <div class='row fill_height'>
                                    ...
                                    <div class='col-lg-8 col-md-6 fill_height'>
                                        <div class='banner_2_image_container'>
                                            <div class='banner_2_image'><img src=<?= Yii::getAlias(
                                                    '@web/images/banner_2_product.png'
                                                ) ?> alt=''></div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class='product_panel panel active'>
                                        <div class='arrivals_slider slider'>
                                            ...
                                            <div class='arrivals_slider_item'>
                                                <div class='border_active'></div>
                                                <div class='product_item is_new d-flex flex-column align-items-center justify-contenwt-center text-center'>
                                                    <div class='product_image d-flex flex-column align-items-center justify-content-center'>
                                                        <img src=<?= Yii::getAlias(
                                                            '@web/images/new_1.jpg'
                                                        ) ?> alt=''></div>
                                                    <div class='product_content'>
                                                        <div class='product_price'>$225</div>
                                                        <div class='product_name'>
                                ...
                                <div class='col-lg-3'>
                                    <div class='arrivals_single clearfix'>
                                        <div class='d-flex flex-column align-items-center justify-content-center'>
                                            <div class='arrivals_single_image'><img src=<?= Yii::getAlias(
                                                    '@web/images/new_single.png'
                                                ) ?> alt=''>
                                            </div>
                                ...
                                <div class='bestsellers_slider slider'>
                                    ...
                                    <div class='bestsellers_item discount'>
                                        <div class='bestsellers_item_container d-flex flex-row align-items-center justify-content-start'>
                                            <div class='bestsellers_image'><img src=<?= Yii::getAlias(
                                                    '@web/images/best_1.png'
                                                ) ?> alt=''></div>
                ...
                <div class='row'>
                        ...
                        <div class='advert d-flex flex-row align-items-center justify-content-start'>
                            ...
                            <div class='ml-auto'>
                                <div class='advert_image'><img
                                            src=<?= Yii::getAlias('@web/images/adv_1.png') ?> alt=''>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class='col-lg-4 advert_col'>
                        ...
                        <div class='advert d-flex flex-row align-items-center justify-content-start'>
                            ...
                            <div class='ml-auto'>
                                <div class='advert_image'><img
                                            src=<?= Yii::getAlias('@web/images/adv_2.png') ?> alt=''>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class='col-lg-4 advert_col'>
                        ...
                        <div class='advert d-flex flex-row align-items-center justify-content-start'>
                            ...
                            <div class='ml-auto'>
                                <div class='advert_image'><img
                                            src=<?= Yii::getAlias('@web/images/adv_3.png') ?> alt=''>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class='owl-carousel owl-theme trends_slider'>
                                ...
                                <div class='owl-item'>
                                    <div class='trends_item is_new'>
                                        <div class='trends_image d-flex flex-column align-items-center justify-content-center'>
                                            <img src=<?= Yii::getAlias('@web/images/trends_1.jpg') ?>
                                                 alt=''></div>
                                ...
                                <div class='owl-item'>
                                    <div class='trends_item'>
                                        <div class='trends_image d-flex flex-column align-items-center justify-content-center'>
                                            <img src=<?= Yii::getAlias('@web/images/trends_2.jpg') ?>
                                                 alt=''></div>
                                        <div class='trends_content'>
                                            <div class='trends_category'><a href='#'>Smartphones</a></div>
                                            <div class='trends_info clearfix'>
                                ...
                                <div class='owl-item'>
                                    <div class='trends_item is_new'>
                                        <div class='trends_image d-flex flex-column align-items-center justify-content-center'>
                                            <img src=<?= Yii::getAlias('@web/images/trends_3.jpg') ?>
                                                 alt=''></div>
                                        <div class='trends_content'>
                                            <div class='trends_category'><a href='#'>Smartphones</a></div>
                                            <div class='trends_info clearfix'>
                            ...
                            <div class='owl-carousel owl-theme reviews_slider'>
                                ...
                                <div class='owl-item'>
                                    <div class='review d-flex flex-row align-items-start justify-content-start'>
                                        <div>
                                            <div class='review_image'><img src=<?= Yii::getAlias(
                                                    '@web/images/review_1.jpg'
                                                ) ?> alt=''></div>
                                        </div>
                            ...
                            <div class='owl-carousel owl-theme viewed_slider'>
                                ...
                                <div class='owl-item'>
                                    <div class='viewed_item discount d-flex flex-column align-items-center justify-content-center text-center'>
                                        <div class='viewed_image'><img
                                                    src=<?= Yii::getAlias('@web/images/view_1.jpg') ?>
                                                    alt=''></div>
                                ...
                                <div class='owl-item'>
                                    <div class='viewed_item d-flex flex-column align-items-center justify-content-center text-center'>
                                        <div class='viewed_image'><img
                                                    src=<?= Yii::getAlias('@web/images/view_2.jpg') ?>
                                                    alt=''></div>
                                        <div class='viewed_content text-center'>
                                ...
                                <div class='owl-item'>
                                    <div class='viewed_item d-flex flex-column align-items-center justify-content-center text-center'>
                                        <div class='viewed_image'><img
                                                    src=<?= Yii::getAlias('@web/images/view_3.jpg') ?>
                                                    alt=''></div>
                                        <div class='viewed_content text-center'>
                                ...
                                <div class='owl-item'>
                                    <div class='viewed_item is_new d-flex flex-column align-items-center justify-content-center text-center'>
                                        <div class='viewed_image'><img
                                                    src=<?= Yii::getAlias('@web/images/view_4.jpg') ?>
                                                    alt=''></div>
                                        <div class='viewed_content text-center'>
                                            <div class='viewed_price'>$379</div>
                                ...
                                <div class='owl-item'>
                                    <div class='viewed_item discount d-flex flex-column align-items-center justify-content-center text-center'>
                                        <div class='viewed_image'><img
                                                    src=<?= Yii::getAlias('@web/images/view_5.jpg') ?>
                                                    alt=''></div>
                                        <div class='viewed_content text-center'>
                                            <div class='viewed_price'>$225<span>$300</span></div>
                                ...
                                <div class='owl-item'>
                                    <div class='viewed_item d-flex flex-column align-items-center justify-content-center text-center'>
                                        <div class='viewed_image'><img
                                                    src=<?= Yii::getAlias('@web/images/view_6.jpg') ?>
                                                    alt=''></div>
                                        <div class='viewed_content text-center'>
                            ...
                            <div class='owl-carousel owl-theme brands_slider'>
                                ...
                                <div class='owl-item'>
                                    <div class='brands_item d-flex flex-column justify-content-center'>
                                        <img src=<?= Yii::getAlias('@web/images/brands_1.jpg') ?>
                                             alt=''>
                                    </div>
                                </div>
                                <div class='owl-item'>
                                    <div class='brands_item d-flex flex-column justify-content-center'>
                                        <img src=<?= Yii::getAlias('@web/images/brands_2.jpg') ?>
                                             alt=''>
                                    </div>
                                </div>
                                <div class='owl-item'>
                                    <div class='brands_item d-flex flex-column justify-content-center'>
                                        <img src=<?= Yii::getAlias('@web/images/brands_3.jpg') ?>
                                             alt=''>
                                    </div>
                                </div>
                                <div class='owl-item'>
                                    <div class='brands_item d-flex flex-column justify-content-center'>
                                        <img src=<?= Yii::getAlias('@web/images/brands_4.jpg') ?>
                                             alt=''>
                                    </div>
                                </div>
                                <div class='owl-item'>
                                    <div class='brands_item d-flex flex-column justify-content-center'>
                                        <img src=<?= Yii::getAlias('@web/images/brands_5.jpg') ?>
                                             alt=''>
                                    </div>
                                </div>
                                <div class='owl-item'>
                                    <div class='brands_item d-flex flex-column justify-content-center'>
                                        <img src=<?= Yii::getAlias('@web/images/brands_6.jpg') ?>
                                             alt=''>
                                    </div>
                                </div>
                                <div class='owl-item'>
                                    <div class='brands_item d-flex flex-column justify-content-center'>
                                        <img src=<?= Yii::getAlias('@web/images/brands_7.jpg') ?>
                                             alt=''>
                                    </div>
                                </div>
                                <div class='owl-item'>
                                    <div class='brands_item d-flex flex-column justify-content-center'>
                                        <img src=<?= Yii::getAlias('@web/images/brands_8.jpg') ?>
                                             alt=''>
                                    </div>
                                </div>
                        ...
                        <div class='newsletter_container d-flex flex-lg-row flex-column align-items-lg-center align-items-center justify-content-lg-start justify-content-center'>
                            <div class='newsletter_title_container'>
                                <div class='newsletter_icon'><img
                                            src=<?= Yii::getAlias('@web/images/send.png') ?> alt=''>
                                </div>
